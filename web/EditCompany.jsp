        ...
        <div class="main-content" style="display: flex; justify-content: center; align-items: center">
            <form action="crud" method="get" style=" width: 70%; display: flex; justify-content: center; align-items: center">
                <table style="width: 90%">
                    ...
                    <tr>
                        <td>ID: </td>
                        <td><input type="text" name="id" value="${company.id}" readonly required> </td>
                    </tr>
                    <tr>
                        <td>Owner: </td>
                        <td><input type="text" name="owner" value="${account.username}" required readonly> </td>
                    </tr>
                    <tr>
                        <td>Name: </td>
                        <td><input type="text" name="name" value="${company.name}" readonly  required> </td>
                    </tr>
                    <tr>
                        <td>Contact: </td>
                        <td><input type="text" name="contact" value="${company.contact}"  required> </td>
                    </tr>
                    <tr>
                        <td>Image: </td>
                        <td><input type="text" name="img" value="${company.img}"  required > </td>
                    </tr>
                    <tr>
                        <td>Mail: </td>
                        <td><input type="text" name="mail" value="${company.mail}"  required > </td>
                    </tr>
                    <tr>
                        <td>Location: </td>
                        <td><input type="text" name="location" value="${company.location}"  required> </td>
                    </tr>
