        ...
        <div class="main-content" style="display: flex; justify-content: center; align-items: center">
            <form action="crud" method="get" style=" width: 70%; display: flex; justify-content: center; align-items: center">
                <table style="width: 90%">
                    ...
                    <tr>
                        <td>Username: </td>
                        <td><input type="text" name="account" value="${account.username}" readonly required> </td>
                    </tr>
                    <tr>
                        <td>Password: </td>
                        <td><input type="text" name="pass" value="${account.password}" required readonly> </td>
                    </tr>
                    <tr>
                        <td>Display Name: </td>
                        <td><input type="text" name="displayName" value="${account.displayName}"  required> </td>
                    </tr>
                    <tr>
                        <td>Contact: </td>
                        <td><input type="text" name="contact" value="${account.contact}"  required> </td>
                    </tr>
                    <tr>
                        <td>Mail: </td>
                    ...
                    <tr>
                        <td>Status: </td>
                        <td><input type="text" name="status" value="${account.status}"  required readonly> </td>
                    </tr>
                    <tr>
