        ...
        <div class="main-content" style="display: flex; justify-content: center; align-items: center">
            <form action="crud" method="get" style=" width: 70%; display: flex; justify-content: center; align-items: center">
                <table style="width: 90%">
                    ...
                    <tr>
                        <td>Owner: </td>
                        <td><input type="text" name="owner" value="${username}" required readonly> </td>
                    </tr>
                    ...
                    <tr>
                        <td>Content: </td>
                        <td><input type="text" name="content" value=""  required > </td>
                    </tr>
                    <tr>
                        <td>Salary: </td>
                        <td><input type="number" name="salary" value="" required style="width: 97%; margin-left: 3%;"> </td>
                    </tr>
